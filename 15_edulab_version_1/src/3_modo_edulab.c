...
void modo_edulab(ptr_user_data new_user){ /*fijate como uso el alias ptr_user_data que defino en el edulab.h*/
   ...
   {
      case LECCION_1:
         system("xdg-open leccion_1.pdf"); /*dispara el apunte 1 en el lector de pdf predeterminado*/
      ...
      case LECCION_2:
         system("xdg-open leccion_2.pdf"); /*dispara el apunte 2 en el lector de pdf predeterminado*/
         instrucciones(leccion);
         preguntero(leccion);
         conclusion(leccion);
      break;
      ...
      case LECCION_3:
         system("xdg-open leccion_3.pdf"); /*dispara el apunte 3 en el lector de pdf predeterminado*/
         instrucciones(leccion);
         preguntero(leccion);
         conclusion(leccion);
      break;
      ...
      case LECCION_4:
         system("xdg-open leccion_4.pdf"); /*dispara el apunte 4 en el lector de pdf predeterminado*/
         instrucciones(leccion);
         preguntero(leccion);
         conclusion(leccion);
      break;
