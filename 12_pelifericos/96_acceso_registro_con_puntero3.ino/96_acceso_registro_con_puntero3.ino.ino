 ...
 *(unsigned char *) 0x2A = 0b01000000;    // Lo que contiene la direccion de memoria 0x2A(fija del DDRD) es 
...
//aqui en loop ya si uso las macros para referirme a los puertos.
